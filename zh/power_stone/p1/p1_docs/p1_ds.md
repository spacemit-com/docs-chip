...
| 56   | PGOOD      | DIO       | Power Good 指示位 / 复位源 | -                                           |
| 57   | AGND       | GND       | 模拟地                   | -                                             |
| 58   | VREF       | AO        | 芯片内部参考电压         | -                                             |
...
| 参数      | 描述           | 条件                                      | 最小值 | 典型值          | 最大值        | 单位 |
|-----------|----------------|-------------------------------------------|--------|-----------------|---------------|------|
| V(IH)     | 高电平输入     | 2.7 ～ 5.5 V，-40 ～ 105 ℃               | 0.7 × AONLDO | -         | -             | V    |
| V(IL)     | 低电平输入     | 2.7 ～ 5.5 V，-40 ～ 105 ℃               | -      | -               | 0.3 × AONLDO  | V    |
...
|      | 5    | ADC_BUCK6_EN      | RW   | 0x0     | BUCK6输出电压监控使能<br/>`0`： 禁止监控<br/>`1`： 使能监控 |
|      | 4    | ADC_BUCK5_EN      | RW   | 0x0     | BUCK5输出电压监控使能<br/>`0`： 禁止监控<br/>`1`： 使能监控 |
|      | 3    | ADC_BUCK4_EN      | RW   | 0x0     | BUCK4输出电压监控使能<br/>`0`： 禁止监控<br/>`1`： 使能监控 |
|      | 2    | ADC_BUCK3_EN      | RW   | 0x0     | BUCK3输出电压监控使能<br/>`0`： 禁止监控<br/>`1`： 使能监控 |
|      | 1    | ADC_BUCK2_EN      | RW   | 0x0     | BUCK2输出电压监控使能<br/>`0`： 禁止监控<br/>`1`： 使能监控 |
|      | 0    | ADC_BUCK1_EN      | RW   | 0x0     | BUCK1输出电压监控使能<br/>`0`： 禁止监控<br/>`1`： 使能监控 |
...
|      | 4:3  | BCHG_ISET     | RW   | 0x0     | 纽扣电池充电电流档位<br/>`100`：500uA<br/>`101`：1mA<br/>`110`：2mA<br/>`111`：4A |
|      | 2:1  | BCHG_VSET     | RW   | 0x0     | 纽扣电池充电电压<br/>`100`：2.8 V<br/>`101`：2.9 V<br/>`110`：3 V<br/>`111`：3.1 V |
