# Document Overview and Notices

```
Last Version: 2025/11/18
```

## K1 User Manual Contents
...
- [12. Video & Graphics](12.Video_&_Graphics.md)
...
For the complete official PDF version, please click to download [K1 User Manual (PDF)](#)
