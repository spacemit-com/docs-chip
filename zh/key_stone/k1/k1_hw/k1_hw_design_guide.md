...
点击下载 **[K1 硬件设计指南（PDF）](https://cdn-resource.spacemit.com/file/chip/K1/K1_Hardware_Design_Guide_zh.pdf)**

## 版本

| 版本 | 日期       | 修订说明                     |
|------|------------|------------------------------|
| V1.2 | 2026.09.04 | 更新 P1 开关电容标注及 1.1.4 节相关图片 |
| V1.1 | 2025.08.04 | 添加了关于未使用 GPIO90 时的说明 |
| V1.0 | 2024.03.12 | 原始版本发布                 |
