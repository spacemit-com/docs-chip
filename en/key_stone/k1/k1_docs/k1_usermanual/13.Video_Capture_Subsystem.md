...
>
> - The system supports dual-camera video stream processing (RAW). In the “4-Lane + 2-Lane + 2-Lane mode (triple sensor)”, one sensor must be a YUV input format source, and the write path should not use the MMU.
