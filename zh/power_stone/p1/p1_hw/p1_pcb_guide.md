...
点击下载 **[P1 PCB 布局布线指南（PDF）](https://cdn-resource.spacemit.com/file/chip/P1/P1_PCB_Layout_Guide_zh.pdf)**
...
| 层名 | 材料                | 厚度（mil） | 厚度（mm） |
|------|---------------------|-------------|------------|
| L1   | 外层铜厚2oz         | 2.76        | 0.0700     |
| PP   | 7628 RC49% 8.6mil   | 7.99        | 0.2030     |
| L2   | 内层铜厚            | 1.18        | 0.0300     |
| 芯板 | 1.1mm 1/1OZ 含铜    | 40.55       | 1.0300     |
| L3   | 内层铜厚            | 1.18        | 0.0300     |
| PP   | 7628 RC49% 8.6mil   | 7.99        | 0.2030     |
| L4   | 外层铜厚2oz         | 2.76        | 0.0700     |
