...
| 版本号 | 日期 | 修订说明 |
| --- | --- | --- |
| **V1.9** | 2026.09.24 | 更新 5.2.1 节双电压 GPIO 绝对最大供电电压 |
| **V1.8** | 2026.08.25 | 第 1.2 节补充 DPU0/DPU1 显示接口支持说明 |
...
- 通过 MIPI-DSI（8 通道，4.5 Gbps/通道）或 DP/eDP 接口，可实现双路 3840×2160@60fps 显示输出。
  > 注：DPU0 支持 MIPI-DSI 或 DP/eDP 接口，DPU1 仅支持 DP/eDP 接口。
