...
1. K3 Pico-ITX 和 K3 CoM260 开发者套件的使用指南在哪里获取？
    ...
    - [K3 Pico-ITX 用户使用指南](https://spacemit.com/community/document/info?lang=en&nodepath=hardware/eco/k3_pico/pico_user_guide.md)
    - [K3 CoM260 开发套件用户使用指南](https://spacemit.com/community/document/info?lang=en&nodepath=hardware/eco/k3_com260/com260_user_guide.md)
